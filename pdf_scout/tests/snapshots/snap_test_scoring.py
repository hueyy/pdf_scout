...
snapshots['test_score_words[./pdf/PUBLIC PROSECUTOR v GCK [2020] SGCA 2 - Judgment.pdf] 1'] = [
    ...
    (
        ...
        {
            'bottom': 650.10100418,
            'bottom_spacing': 43.21,
            'direction': 1,
            'doctop': 18292.32525695,
            'fontname': 'FAAAIC+BookmanOldStyle-Bold',
            'page_number': 22,
            'size': 10.0,
            'text': 'Reference to Court of Appeal of criminal matter determined by High Court in exercise of its appellate or revisionary jurisdiction',
            'top': 616.62500054,
            'top_spacing': 32.64,
            'upright': True,
            'x0': 144.0,
            'x1': 454.8500000000002
        }
    ),
    (
        {
